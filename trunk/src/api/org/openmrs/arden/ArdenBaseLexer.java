...
public ArdenBaseLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("PRESENT", this), new Integer(131));
	...
	literals.put(new ANTLRHashString("LIST", this), new Integer(137));
	...
	literals.put(new ANTLRHashString("time", this), new Integer(85));
	literals.put(new ANTLRHashString("call", this), new Integer(87));
	literals.put(new ANTLRHashString("EVENT", this), new Integer(128));
	literals.put(new ANTLRHashString("expired", this), new Integer(106));
	...
	literals.put(new ANTLRHashString("end", this), new Integer(91));
	literals.put(new ANTLRHashString("Event", this), new Integer(129));
	literals.put(new ANTLRHashString("production", this), new Integer(103));
	literals.put(new ANTLRHashString("months", this), new Integer(50));
	literals.put(new ANTLRHashString("+", this), new Integer(115));
	literals.put(new ANTLRHashString("STRING", this), new Integer(136));
	...
	literals.put(new ANTLRHashString("NUMBER", this), new Integer(134));
	literals.put(new ANTLRHashString("seconds", this), new Integer(145));
	...
	literals.put(new ANTLRHashString("minutes", this), new Integer(143));
	...
	literals.put(new ANTLRHashString("t", this), new Integer(113));
	literals.put(new ANTLRHashString("Occur", this), new Integer(147));
	literals.put(new ANTLRHashString("to", this), new Integer(89));
	...
	literals.put(new ANTLRHashString("occurs", this), new Integer(151));
	literals.put(new ANTLRHashString("less", this), new Integer(12));
	literals.put(new ANTLRHashString("NULL", this), new Integer(132));
	literals.put(new ANTLRHashString("date", this), new Integer(83));
	literals.put(new ANTLRHashString("validation", this), new Integer(102));
	...
	literals.put(new ANTLRHashString("Z", this), new Integer(117));
	literals.put(new ANTLRHashString("last", this), new Integer(38));
	literals.put(new ANTLRHashString("GT", this), new Integer(161));
	literals.put(new ANTLRHashString("arden", this), new Integer(97));
	...
	literals.put(new ANTLRHashString("REFUTE", this), new Integer(120));
	literals.put(new ANTLRHashString("title", this), new Integer(71));
	literals.put(new ANTLRHashString("was", this), new Integer(8));
	literals.put(new ANTLRHashString("with", this), new Integer(88));
	...
	literals.put(new ANTLRHashString("occur", this), new Integer(148));
	literals.put(new ANTLRHashString("at", this), new Integer(21));
	literals.put(new ANTLRHashString("of", this), new Integer(84));
	literals.put(new ANTLRHashString("is", this), new Integer(6));
	literals.put(new ANTLRHashString("DURATION", this), new Integer(135));
	literals.put(new ANTLRHashString("OBJECT", this), new Integer(138));
	...
	literals.put(new ANTLRHashString("any", this), new Integer(90));
	...
	literals.put(new ANTLRHashString("ASTM-E", this), new Integer(98));
	...
	literals.put(new ANTLRHashString("second", this), new Integer(144));
	literals.put(new ANTLRHashString("hour", this), new Integer(140));
	literals.put(new ANTLRHashString("keywords", this), new Integer(79));
	literals.put(new ANTLRHashString("hours", this), new Integer(141));
	literals.put(new ANTLRHashString("OCCURS", this), new Integer(149));
	literals.put(new ANTLRHashString("SUPPORT", this), new Integer(119));
	literals.put(new ANTLRHashString("z", this), new Integer(118));
	literals.put(new ANTLRHashString("Occurred", this), new Integer(153));
	...
	literals.put(new ANTLRHashString("T", this), new Integer(112));
	literals.put(new ANTLRHashString("research", this), new Integer(104));
	literals.put(new ANTLRHashString("mlmname", this), new Integer(70));
	literals.put(new ANTLRHashString("minute", this), new Integer(142));
	literals.put(new ANTLRHashString("were", this), new Integer(9));
	literals.put(new ANTLRHashString("day", this), new Integer(48));
	literals.put(new ANTLRHashString("data-driven", this), new Integer(122));
	...
	literals.put(new ANTLRHashString(".", this), new Integer(114));
	literals.put(new ANTLRHashString("else", this), new Integer(58));
	literals.put(new ANTLRHashString(":", this), new Integer(111));
	...
	literals.put(new ANTLRHashString("data_driven", this), new Integer(123));
	...
	literals.put(new ANTLRHashString("within", this), new Integer(86));
	...
	literals.put(new ANTLRHashString("testing", this), new Integer(105));
