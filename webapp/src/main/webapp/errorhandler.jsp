...
<font color="red">
	<h2>An error has occurred!</h2> The following error happened somewhere
	on this page:<br /> <%=exception.toString()%> <br />
<br /> (The full error stack trace output is in the source of this
	page.)
</font>
...
<%
	org.apache.commons.logging.LogFactory.getLog(getClass())
				.error("Error on page " + request.getRequestURI(), exception);
