...
<h2>
	<openmrs:message code="PersonAttributeType.title" />
</h2>
	...
	<fieldset>
		<table>
			<tr>
				...
				<td><spring:bind path="personAttributeType.name">
			...
			<tr>
				...
				<td><spring:bind path="personAttributeType.format">
						...
						<c:set var="isJavaUtilDate"
							value='${status.value == "java.util.Date"}' />
						<select name="format">
							<option value=""></option>
				...
				<td><i><openmrs:message
							code="PersonAttributeType.format.help" /></i></td>
			</tr>
			<tr>
				<td><openmrs:message code="PersonAttributeType.foreignKey" /></td>
				<td><spring:bind path="personAttributeType.foreignKey">
						<input type="text" name="foreignKey" value="${status.value}"
							size="35" />
						<c:if test="${status.errorMessage != ''}">
							<span class="error">${status.errorMessage}</span>
						</c:if>
				...
				<td><i><openmrs:message
							code="PersonAttributeType.foreignKey.help" /></i></td>
			</tr>
			<tr>
				<td><openmrs:message code="PersonAttributeType.searchable" /></td>
				<td><spring:bind path="personAttributeType.searchable">
				...
				<td><i><openmrs:message
							code="PersonAttributeType.searchable.help" /></i></td>
			</tr>
			<tr>
				<td valign="top"><openmrs:message code="general.description" /></td>
				<td valign="top"><spring:bind
						path="personAttributeType.description">
			...
			<tr>
				...
				<td><spring:bind path="personAttributeType.editPrivilege">
						<select name="editPrivilege">
							<option value=""></option>
							<c:forEach items="${privileges}" var="privilege">
								<option value="${privilege.privilege}"
									<c:if test="${privilege.privilege == status.value}">selected</c:if>>${privilege.privilege}</option>
							</c:forEach>
						</select>
						<c:if test="${status.errorMessage != ''}">
							<span class="error">${status.errorMessage}</span>
				...
				<td><i><openmrs:message
							code="PersonAttributeType.editPrivilege.help" /></i></td>
			</tr>
			<c:if test="${personAttributeType.creator != null}">
				<tr>
					<td><openmrs:message code="general.createdBy" /></td>
					<td>${personAttributeType.creator.personName} - <openmrs:formatDate
							date="${personAttributeType.dateCreated}" type="long" />
					</td>
				</tr>
			</c:if>
			<c:if test="${personAttributeType.changedBy != null}">
				<tr>
					...
					<td>${personAttributeType.changedBy.personName} - <openmrs:formatDate
							date="${personAttributeType.dateChanged}" type="long" />
					</td>
				</tr>
			</c:if>
			<tr>
		...
		<input type="hidden" name="personAttributeTypeId:int"
			value="${personAttributeType.personAttributeTypeId}"> <br />
		<input type="submit"
			value="<openmrs:message code="PersonAttributeType.save"/>"
			name="save">
	</fieldset>
</form>
...
<c:if
	test="${not personAttributeType.retired && not empty personAttributeType.personAttributeTypeId}">
	<form method="post">
		<fieldset>
			<h4>
				<openmrs:message
					code="PersonAttributeType.retirePersonAttributeType" />
			</h4>
			...
			<br /> <input type="submit"
				value='<openmrs:message code="PersonAttributeType.retirePersonAttributeType"/>'
				name="retire" />
		</fieldset>
	</form>
</c:if>
	...
	<openmrs:hasPrivilege privilege="Manage Person Attribute Types">
		<form id="unretire" method="post" onsubmit="return confirmUnretire()">
			<fieldset>
				<h4>
					<openmrs:message
						code="PersonAttributeType.UnretirePersonAttributeType" />
				</h4>
				<input type="submit"
	...
	<openmrs:hasPrivilege privilege="Purge Person Attribute Types">
		<form id="purge" method="post" onsubmit="return confirmPurge()">
			<fieldset>
				<h4>
					<openmrs:message
						code="PersonAttributeType.purgePersonAttributeType" />
				</h4>
				<input type="submit"
					value='<openmrs:message code="PersonAttributeType.purgePersonAttributeType"/>'
					name="purge" />
			</fieldset>
		</form>
	</openmrs:hasPrivilege>
