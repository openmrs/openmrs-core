...
<script type="text/javascript">
	...
	function onFormSubmission(){
		...
		if (patientIdChanged) {
			...
			return confirm('<openmrs:message code="Encounter.transfer.confirm_patient_change" javaScriptEscape="true" arguments="${encounter.patient.personName}" />  <openmrs:message code="Encounter.transfer.to" javaScriptEscape="true"/> '
