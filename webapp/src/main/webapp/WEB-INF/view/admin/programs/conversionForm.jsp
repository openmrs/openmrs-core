...
<h2>
	<openmrs:message code="Program.conversion.manage.title" />
</h2>
...
<form method="post" id="theForm">
	<table>
		<tr>
			...
			<td><spring:bind path="conversion.programWorkflow">
					<openmrs:fieldGen type="org.openmrs.ProgramWorkflow"
						formFieldName="programWorkflow" val="${status.editor.value}"
		...
		<tr>
			...
			<td><spring:bind path="conversion.concept">
					<openmrs:fieldGen type="org.openmrs.Concept"
						formFieldName="concept" val="${status.editor.value}" parameters="" />
					<c:if test="${status.errorMessage != ''}">
						<span class="error">${status.errorMessage}</span>
					</c:if>
				</spring:bind></td>
		...
		<tr>
			<td><openmrs:message
					code="Program.conversion.programWorkflowState" />:</td>
			<td><spring:bind path="conversion.programWorkflowState">
	...
	<br /> <input type="submit"
		value='<openmrs:message code="Program.conversion.save"/>'
