...
<b class="boxHeader"><spring:message code="Hl7InArchive.migrate.title"/></b>		
	...
	<div style="padding: 1em;">
		<div id="message" class="ui-widget" style="margin-bottom: 1em;">
			<div class="ui-state-highlight ui-corner-all" style="padding: 0.5em;">
				...
				<span class="content" style="font-size: 0.9em;"><spring:message code="Hl7InArchive.migrate.warning.message"/></span>
			</div>
		</div>
		<p>
			<b><spring:message code="Hl7InArchive.migrate.archives.dir"/>:</b> ${hl7_archives_dir}
		</p>
		<span id="daysKeptHighlight" style="margin:-0.5em 0.5em 0 -0.5em; padding:0.5em; whitespace:nowrap;">
			<label for="daysKept"><spring:message code="Hl7InArchive.migrate.days.kept"/></label>:
			<input id="daysKept" name="daysKept" type="text" value="365" size="5"/>
			<span id="daysKeptError"><spring:message code="Hl7InArchive.migrate.days.kept.error"/></span>
		</span>
