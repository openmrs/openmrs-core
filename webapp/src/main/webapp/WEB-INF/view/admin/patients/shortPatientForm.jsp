			...
			<table id="identifiers" cellspacing="2">
				...
				<tbody id="identifiersTbody">
					...
					<td valign="middle">
						...
						<input type="button" name="closeButton" onClick="removeRow(this, 'identifiers[${varStatus.index}].isVoided');" class="closeButton" value='<openmrs:message code="general.remove"/>'/>
						</spring:bind>
					</td>
					</tr>
					</spring:nestedPath>
