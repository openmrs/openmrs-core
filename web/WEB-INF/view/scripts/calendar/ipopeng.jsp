...
<html>
<head>
<title>PopCalendarXP 9.6.282 Lite Edition - Copyright 2003-2006 Idemfactor Solutions, Inc.</title>
...
document.write("<scr"+"ipt type='text/javascript' "+_charset+" src='"+gTheme[1]+"?"+(_cacheOther?0:gd.getTime())+"'></scr"+"ipt>");
</script>
</head>
<body leftmargin=0 topmargin=0 marginwidth=0 marginheight=0 hspace=0 vspace=0 onload="fInitRange();if(fOnload)fOnload()" onselectstart="return false" ondraggesture="return false" ondragstart="return false" oncontextmenu="return false" onmouseup="top.defaultStatus='Powered by PopCalendarXP 9.6.282 Lite Edition (c)2003-2006 Idemfactor Solutions, Inc.';fDragIt(0,0,0,2,event);return true;">
<script type='text/javascript'>
