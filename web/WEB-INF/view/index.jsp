...
<center>
<img src="${pageContext.request.contextPath}<spring:theme code="image.logo.large"/>" alt='<openmrs:message code="openmrs.title"/>' title='<openmrs:message code="openmrs.title"/>'/>
