	...
	<c:choose>
		...
		<c:when test="${model.size == 'full'}">
			...
			<div id="findPatient">
				...
				<div class="box">
					<div dojoType="PatientSearch" widgetId="pSearch" searchLabel='<spring:message code="formentry.searchBox"/>' showVerboseListing="true" patientId='<request:parameter name="patientId"/>' searchPhrase='<request:parameter name="phrase"/>' showAddPatientLink='false'></div>
				</div>
			</div>
