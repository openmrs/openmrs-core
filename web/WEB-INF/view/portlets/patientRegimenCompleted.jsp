				...
				<tbody id="regimenTableCompleted___other__">
					<c:if test="${not empty model.completedDrugOrderSets['*']}">
						<c:forEach items="${model.completedDrugOrderSets['*']}" var="drugOrder">
							<tr>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;<span class="patientRegimenDrugName" href="${pageContext.request.contextPath}/admin/orders/orderDrug.form?orderId=${drugOrder.orderId}">${drugOrder.drug.name}</span></td>
