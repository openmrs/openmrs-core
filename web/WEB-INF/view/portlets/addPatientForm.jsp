			...
			<form method="get" action="${model.postURL}" onSubmit="return validateForm()">
				<table>
					<tr>
						...
						<td>
							<input type="text" name="name" id="patientName" size="40" onKeyUp="clearError('name')" />
							<span class="error" id="nameError"><spring:message code="Patient.name.required"/></span>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<span class="error" id="birthyearError"><spring:message code="Patient.birthyear.required"/></span>
						</td>
					</tr>
					<tr>
