...
<openmrs:portlet url="patientSet" id="patientSetHeader" size="compact" parameters="linkUrl=patientSummary.form|allowRemove=true|allowClear=true|selectedPatientId=${patient.patientId}|mutable=true|droppable=true"/>
