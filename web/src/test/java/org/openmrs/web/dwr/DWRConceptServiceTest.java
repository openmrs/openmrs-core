...
public class DWRConceptServiceTest extends BaseWebContextSensitiveTest {
	...
	public void findConceptAnswers_shouldSearchForConceptAnswersInAllSearchLocales() throws Exception {
		...
		answer1.addDescription(new ConceptDescription("some description", new Locale("pl")));
		...
		answer2.addDescription(new ConceptDescription("some description", new Locale("pl")));
		...
		answer3.addDescription(new ConceptDescription("some description", new Locale("pl")));
