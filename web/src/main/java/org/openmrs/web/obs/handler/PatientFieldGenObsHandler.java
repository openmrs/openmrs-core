 ...
 * The Patient Id of each Patient object is stored in the value_complex column of the 
 * Obs table. This value may be preceded by an optional displayable value. 
 * 
 * This class extends org.openmrs.obs.handler.PatientHandler
 * for PatientHandlers. You may also consider extending
 ...
 * 
 * As default, PatientHandler will have the lowest possible
 * priority, and will be overridden by PatientFieldGenObsHandler, which lets us use fieldGen tags
 * for data entry.
 */
@Component
@Order(0)
