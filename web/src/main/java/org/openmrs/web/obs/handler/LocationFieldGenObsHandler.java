 ...
 * each Location object is stored in the value_complex column of the Obs table. This value may be
 * preceded by an optional displayable value. This class extends
 * org.openmrs.obs.handler.LocationHandler for LocationHandlers. You may also consider extending
 ...
 * possible priority, and will be overridden by LocationFieldGenObsHandler, which lets us use
