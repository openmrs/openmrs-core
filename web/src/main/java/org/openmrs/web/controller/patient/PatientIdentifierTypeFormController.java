	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object obj,
		...
		if (Context.isAuthenticated()) {
			...
			try {
				...
				log
				        .error(
				            "tried to save, retire, unretire or purge a patient identifier type while patient identifier types were locked",
				            e);
				httpSession.setAttribute(WebConstants.OPENMRS_ERROR_ATTR,
				    "PatientIdentifierType.patientIdentifierTypes.locked");
				if (identifierType.getPatientIdentifierTypeId() != null) {
					view = "patientIdentifierType.form?patientIdentifierTypeId="
