...
public class ForgotPasswordFormController extends SimpleFormController {
	...
	Map<String, Integer> usersmap = new HashMap<String, Integer>(7);
		...
		if (lockedOut) {
			...
			if (secretAnswer == null) {
				...
				if (user == null) {
					...
					request.setAttribute("secretQuestion", getRandomFakeSecretQuestion(questions));
	...
	public List<String> getList() {
		List<String> questions = new ArrayList<String>(7);
	...
	public String getRandomFakeSecretQuestion(List<String> questions) {
		if (questions.size() != 0) {
