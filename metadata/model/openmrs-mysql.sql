...
Source Server Version: 4.1.9-nt-max
Source Database:       amrs
Date:                  2005/09/09 16:35:06
*/
...
CREATE TABLE `complex_obs` (
  ...
  PRIMARY KEY  (`obs_id`),
  KEY `mime_type_of_content` (`mime_type`),
  CONSTRAINT `mime_type_of_content` FOREIGN KEY (`mime_type`) REFERENCES `mime_type` (`mime_type`),
...
CREATE TABLE `concept` (
  ...
  `correct_concept` int(11) default NULL,
  ...
  `old_datatype` varchar(50) default NULL,
  `table_name` varchar(255) default NULL,
  `column_name` varchar(255) default NULL,
  `form_location` varchar(50) default NULL,
  `bev_count` int(11) default NULL,
...
#----------------------------
# Table structure for concept_set2
#----------------------------
drop table if exists concept_set2;
CREATE TABLE `concept_set2` (
  `concept_id` int(11) NOT NULL default '0',
  `concept_set` int(11) NOT NULL default '0',
  `sort_weight` double default NULL,
  PRIMARY KEY  (`concept_id`,`concept_set`)
...
#----------------------------
# Table structure for drug_orders
#----------------------------
...
CREATE TABLE `drug_orders` (
  ...
  KEY `drug_orders_creator` (`creator`),
  KEY `inventory_item` (`drug_inventory_id`),
  CONSTRAINT `drug_orders_creator` FOREIGN KEY (`creator`) REFERENCES `users` (`user_id`),
...
CREATE TABLE `encounter` (
  ...
  KEY `encounter_creator` (`creator_id`),
  ...
  CONSTRAINT `encounter_creator` FOREIGN KEY (`creator_id`) REFERENCES `users` (`user_id`),
...
CREATE TABLE `patient_identifier` (
  ...
  `date_voided` datetime default NULL,
  `void_reason` varchar(255) default NULL,
  PRIMARY KEY  (`patient_id`,`identifier`,`identifier_type`,`location`),
  KEY `defines_identifier_type` (`identifier_type`),
  KEY `identifier_location` (`location`),
  ...
  CONSTRAINT `identifier_location` FOREIGN KEY (`location`) REFERENCES `location` (`location_id`),
