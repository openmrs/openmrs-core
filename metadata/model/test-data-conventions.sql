...
where
  o.voided = false
  and ((dt.hl7_abbreviation in ('NM', 'SN', 'BIT') and o.value_numeric is null) or
       (dt.hl7_abbreviation in ('DT', 'TM', 'TS') and o.value_datetime is null) or
       (dt.hl7_abbreviation in ('CWE') and o.value_coded is null)  or
       (dt.hl7_abbreviation in ('ST') and o.value_text is null))
group by dt.name;