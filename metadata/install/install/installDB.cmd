...
ECHO **************************************
ECHO Upgrading to Latest Datamodel
REM "$MySQL_Install_Directory\bin\mysql.exe" -u$MySQL_Admin_User -p$MySQL_Admin_Password -D$Database_Name < "$INSTALL_PATH\model\openmrs_1.0.0-to-latest-mysqldiff.sql"
ECHO NOT DONE - UPGRADE FAILS WITH DATA
ECHO **************************************
ECHO Adding Data
...
ECHO ***********************
java -classpath "$INSTALL_PATH\bin" org.cl.installer.DeployTomcat $Tomcat_Admin_User $Tomcat_Admin_Password "http://localhost:8080/manager/deploy?path=/openmrs&war=$INSTALL_PATH\openmrs.war"
