 ...
 * 
 * If an object is parameterizable, it is willing to accept a parameter like this.
 * 
 * Examples of a parameter would be "What start date do you want to use?"  The 
 * value of the parameter would be plugged in when the object is evaluated.
 * 
 * @see ReportModel
 * @see LogicCriteria
