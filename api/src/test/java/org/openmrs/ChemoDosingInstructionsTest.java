...
public class ChemoDosingInstructionsTest extends BaseContextSensitiveTest {
	...
	public void getDosingInstructionsAsString_shouldInferCorrectly() {
		...
		assertEquals(dosingInstructions, shouldBeResult);
	}
	...
	public void setDosingInstructions_shouldBeSetCorrectly() {
		...
		assertEquals(drugOrder.getDosingType(), ChemoDosingInstructions.class);
		assertEquals(drugOrder.getDosingInstructions(), shouldBeResult);
	}
	...
	public void getDosingInstructions_shouldInferCorrectly() {
		...
		ChemoDosingInstructions dosingInstructions = (ChemoDosingInstructions) instructions
				.getDosingInstructions(order);

		assertEquals(dosingInstructions.getDosageAdjustmentPercentage(), ADJUSTMENT_PERCENTAGE_CONSTANT);
		assertEquals(dosingInstructions.getDosageDeliveredTiming(), DELIVERED_TIMING_CONSTANT);
		assertEquals(dosingInstructions.getDosageDilutionInstructions(), DILUTION_INSTRUCTIONS_CONSTANT);
	}
