...
public class UpdateFileParserTest {
	...
	/**
	 * @verifies parse update.rdf with version 1.0
	 */
	@Test
	public void parse_shouldSetPropertiesUsingOnlyUpdate() {
	...
	/**
	 * @verifies parse update.rdf with multiple updates
	 */
	@Test
	...
	/**
	 * @verifies parse skips updates ahead of openmrs's version
	 */
	@Test
	public void parse_shouldSkipFirstUpdate() {
