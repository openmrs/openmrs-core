...
public class MedicationDispenseBuilder {
	...
	public MedicationDispenseBuilder withEncounter(Integer encounterID) {
		...
		medicationDispense.setProvider(e.getActiveEncounterProviders().iterator().next().getProvider());
		return this;
	}
	...
	public MedicationDispenseBuilder withProvider(Integer providerId) {
		medicationDispense.setProvider(Context.getProviderService().getProvider(providerId));
		return this;
	}
	...
	public MedicationDispenseBuilder withDrug(Integer drugID, 
											  Integer substitutionTypeConceptId, 
	...
	public MedicationDispenseBuilder withNote(String note) {
		medicationDispense.setNote(note);
		return this;
	}
