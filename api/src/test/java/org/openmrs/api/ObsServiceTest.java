...
public class ObsServiceTest extends BaseContextSensitiveTest {
	 ...
	 */
	@Test
	@Verifies(value = "Should delete any obsGroupMembers here before deleting the obs", method = "purgeObs(Obs)")
	public void purgeObs_shouldDeleteObsGroupMembersBeforeDeletingTheObs() throws Exception {
	 ...
	 */
	@Test
	@Verifies(value = "Should not delete referenced orders when purging obs", method = "purgeObs(Obs)")
