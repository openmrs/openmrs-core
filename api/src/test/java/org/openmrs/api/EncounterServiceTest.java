...
public class EncounterServiceTest extends BaseContextSensitiveTest {
	...
	public void saveEncounter_shouldNotOverwriteObsAndOrdersCreatorOrDateCreated()
		...
		Obs obs = new Obs(new Patient(2), new Concept(1), new Date(),
				new Location(1));
		...
		// set
		Order createdOrder = Context.getOrderService().getOrder(
				order.getOrderId());
	...
	public void saveEncounter_shouldCascadeCreatorAndDateCreatedToOrders()
			throws Exception {
		EncounterService encounterService = Context.getEncounterService();
	...
	public void getEncounters_shouldGetEncountersByLocation() throws Exception {
		List<Encounter> encounters = Context.getEncounterService()
				.getEncounters(null, new Location(1), null, null, null, null,
						null, true);
	...
	public void getEncounters_shouldGetEncountersOnOrAfterDate()
		...
		List<Encounter> encounters = Context.getEncounterService()
				.getEncounters(null, null, ymd.parse("2004-12-31"), null, null,
						null, null, false);
		...
		encounters = Context.getEncounterService().getEncounters(null, null,
				ymd.parse("2005-01-01"), null, null, null, null, false);
		assertEquals(4, encounters.size());

		// test for one day later
		encounters = Context.getEncounterService().getEncounters(null, null,
				ymd.parse("2005-01-02"), null, null, null, null, false);
	...
	public void getEncounters_shouldGetEncountersOnOrUpToADate()
		...
		List<Encounter> encounters = Context
				.getEncounterService()
				.getEncounters(null, null, null, toDate, null, null, null, true);
		assertEquals(2, encounters.size());
	...
	public void getEncounters_shouldGetEncountersByForm() throws Exception {
		...
		List<Encounter> encounters = Context.getEncounterService()
				.getEncounters(null, null, null, null, forms, null, null, true);
	...
	public void getEncounters_shouldGetEncountersByProvider() throws Exception {
		...
		List<Encounter> encounters = Context.getEncounterService()
				.getEncounters(null, null, null, null, null, null, providers,
						true);
		assertEquals(3, encounters.size());
	}
	...
	public void getEncounters_shouldGetEncountersByType() throws Exception {
		...
		List<Encounter> encounters = Context.getEncounterService()
				.getEncounters(null, null, null, null, null, types, null, true);
		assertEquals(5, encounters.size());
	}
	...
	public void getEncounters_shouldExcludeVoidedEncounters() throws Exception {
		assertEquals(5, Context.getEncounterService().getEncounters(null, null,
				null, null, null, null, null, false).size());
	}
	...
	public void getEncounters_shouldIncludeVoidedEncounters() throws Exception {
		assertEquals(6, Context.getEncounterService().getEncounters(null, null,
	...
	public void saveEncounterType_shouldNotOverwriteCreator() throws Exception {
		...
		// make sure the logged in user isn't the user we're testing with
		assertNotSame(encounterType.getCreator(), Context
	...
	/**
	 * There should be two encounters in the system with the name
	 * "Test Enc Type A" and one should be retired and one not. Only the non
	 * retired one should be returned here
	 * 
	...
	public void getEncounterType_shouldNotGetRetiredTypes() throws Exception {
		...
		assertEquals(
				"We are only expecting to have two types: one retired, one not",
				2, countOfTestEncType2s);
	...
	public void retireEncounterType_shouldRetireTypeAndSetAttributes()
		...
		assertEquals(Context.getAuthenticatedUser(), retiredEncType
				.getRetiredBy());
