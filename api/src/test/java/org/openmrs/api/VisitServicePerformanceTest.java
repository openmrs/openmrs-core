...
public class VisitServicePerformanceTest extends BaseContextSensitiveTest {
    ...
    /**
     * Enables Hibernate SQL logging to observe query execution patterns.
     */
    @BeforeAll
    ...
    public void shouldDemonstrateSlowPerformanceWithManyVisits() {
        ...
        // Setup: Create 2000 visits to demonstrate performance impact
        int visitCount = 2000;
        ...
        for (int i = 0; i < visitCount; i++) {
            ...
            // Periodically flush to avoid memory issues with large batch
            if (i % 50 == 0) {
        ...
        // Execution: Measure time using optimized eager fetching
        long startTime = System.currentTimeMillis();
        
        patient = patientService.getPatient(2);
        
        // Create criteria with eager fetching enabled to prevent N+1 queries
        ...
        // Access encounters to trigger lazy loading (simulates REST API behavior)
        ...
        // Verify expected number of visits (2000 new + 3 from test data)
