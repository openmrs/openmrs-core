...
public class S3StorageServiceIT extends BaseStorageServiceTest {
	...
	public static void setupS3Client() {
		s3AsyncClient = S3AsyncClient.builder().multipartEnabled(true).region(Region.of("us-east-1"))
		        .credentialsProvider(StaticCredentialsProvider.create(AwsBasicCredentials.create("foo", "bar")))
		        .endpointOverride(URI.create(S3_MOCK.getHttpEndpoint())).forcePathStyle(true).build();
	}
