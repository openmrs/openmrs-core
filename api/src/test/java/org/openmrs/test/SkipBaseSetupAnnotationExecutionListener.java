...
/**
 * This class is added to all {@link org.openmrs.test.jupiter.BaseContextSensitiveTest} classes due
 * to being in the list of "@TestExecutionListeners" annotation. This looks for the
 * "@SkipInitializationData", "@SkipStandardData" and "@SkipAuthorization" annotations on the
 * current test method and skips the associated action in the
 * {@link org.openmrs.test.jupiter.BaseContextSensitiveTest#setupDatabaseWithStandardData()} method
 *
 * @see SkipBaseSetup
...
public class SkipBaseSetupAnnotationExecutionListener extends AbstractTestExecutionListener {
	 ...
	 * {@link org.openmrs.test.jupiter.BaseContextSensitiveTest} class.
	 *
	...
	private void callMethod(TestContext testContext, String methodName) throws Exception {
		...
		try {
			...
			throw new Exception(
			        "There is no method named '" + methodName + "' on the " + testContext.getTestClass() + " class", e);
		}
