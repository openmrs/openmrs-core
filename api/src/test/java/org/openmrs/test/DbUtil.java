 ...
 * org.openmrs.test.jupiter.BaseContextSensitiveTest, replace Containers.ensureDatabaseRunning()
 * with DbUtil.ensureDatabaseCreated() and then run: mvn test -DuseInMemoryDatabase=false If you do
 * not want to use the defaults, you can use the optional command line options below: -DdatabaseName
