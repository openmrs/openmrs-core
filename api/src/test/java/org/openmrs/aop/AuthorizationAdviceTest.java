...
public class AuthorizationAdviceTest extends BaseContextSensitiveTest {
	...
	public void before_shouldNotifyListenersAboutCheckedPrivileges() {
		...
		assertThat("listener1", listener1.hasPrivileges, containsInAnyOrder("Manage Concepts", "Get Observations", "Get Concept Attribute Types", "Get Concept Map Types"));
		assertThat("listener2", listener2.hasPrivileges, containsInAnyOrder("Manage Concepts", "Get Observations", "Get Concept Attribute Types", "Get Concept Map Types"));
		assertThat(listener1.lacksPrivileges, empty());
		assertThat(listener2.lacksPrivileges, empty());
	}
