...
public class DoubleRangeTest {
	...
	@Test
	@Verifies(value = "make getHigh return the set value", method = "setHigh(Double high)")
	public void setHigh_shouldMakeGetHighReturnTheSetValue() {
		DoubleRange dr = new DoubleRange(null, null);
		dr.setHigh(8.0);
	...
	@Test
	@Verifies(value = "make getLow return the set value", method = "setLow(Double low)")
