...
public class GlobalPropertiesTestHelper {
	...
	public String setGlobalProperty(String propertyName, String propertyValue) {
		...
		Assertions.assertEquals(propertyValue, administrationService.getGlobalProperty(propertyName));
	...
	public void purgeGlobalProperty(String propertyName) {
		...
		Assertions.assertNull(administrationService.getGlobalProperty(propertyName));
	}
