...
/**
 * Aggregates events <i>SaveServiceEvent&lt;GlobalProperty&gt;</i> and
 * <i>SaveDbEvent&lt;GlobalProperty&gt;</i> into {@link TestAggregatedEntityEvent}.
 */
@Component
	...
	public boolean supportsEvent(EntityEvent<?> event) {
		...
		if (resolvableType != null) {
			return resolvableType
			        .isAssignableFrom(ResolvableType.forClassWithGenerics(SaveServiceEvent.class, GlobalProperty.class))
			        || resolvableType
			                .isAssignableFrom(ResolvableType.forClassWithGenerics(SaveDbEvent.class, GlobalProperty.class));
		}
		return false;
	}
