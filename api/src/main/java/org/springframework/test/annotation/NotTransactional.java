/** 
 * NOTE: this class, which has been removed in Spring 4, has been copied over from Spring 3.2.7 to support old style junit tests that still
 * rely on @NotTransactional.
 **/
