...
public class ConceptNumeric extends Concept {
	...
	/**
	 * displayPrecision, represents the number of significant digits to be used for display of a numeric
	 * value
	 */
	 ...
	 * <p>
	 * <strong>Should</strong> make deep copy of collections<br/>
	 * <strong>Should</strong> change reference to the parent object for objects in answers
	 * collection<br/>
	 * <strong>Should</strong> change reference to the parent object for objects in conceptSets
	 * collection<br/>
	 * <strong>Should</strong> change reference to the parent object for objects in names
	 * collection<br/>
