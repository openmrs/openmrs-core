...
public interface LogicDataSource {
	...
	/**
	 * The name by which this data source should be registered when it is loaded. Implementations should
	 * override this like public static final String NAME = "person";
	 */
