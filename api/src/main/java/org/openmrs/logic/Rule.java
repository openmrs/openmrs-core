...
public interface Rule {
	...
	/**
	 * Gets the default datatype that the rule returns, when supplied with a given token. While results
	 * are loosely typed, this method allows rules to declare a default datatype to simplify user
	 * interfaces and defaults when working with rules.
	 *
	 * @return datatype
	 */
