...
public abstract class SerializingCustomDatatype<T> implements CustomDatatype<T> {
	...
	/**
	 * Most implementations should override this method to return plain-text summary of the typed value,
	 * as defined by {@link CustomDatatype#getTextSummary(String)}. If {@link #deserialize(String)} is
	 * expensive, then the implementation should override {@link #getTextSummary(String)} instead. The
	 * default implementation returns typedValue.toString(), and indicates it is complete.
	 *
	 * @param typedValue
