...
public interface HL7Service extends OpenmrsService {
	...
	/**
	 * Get the archive item with the given id, If hl7 archives were moved to the file system, you can't
	 * do a look up by hl7ArchiveId, instead call {@link HL7Service#getHL7InArchiveByUuid(String)}
	 *
	...
	/**
	 * If hl7 migration has been run and the state matches that of processed items, the method returns a
	 * list of all archives in the file system, for any other state , it returns an empty list, this is
	 * because all archives would have a status of 'processed' after migration and all deleted archives
	 * moved back into the queue with a status of 'deleted' otherwise it returns archives with a
	 * matching state if migration hasn't yet been run.
	 *
	 ...
	 * correspond internal identifier of the specified location. If only location_name is specified, it
	 * tries to return location internal identifier by given name
	 * <p>
	 * <strong>Should</strong> return internal identifier of location if only location name is
	 * specified<br/>
	 * <strong>Should</strong> return internal identifier of location if only location id is
	 * specified<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> find a person based on a patient identifier<br/>
	 ...
	 * @return The internal id number of a Person based on one of the given identifiers, or null if the
	 *         Person is not found
	 * @throws HL7Exception
	 */
	 ...
	 * <p>
	 * <strong>Should</strong> create HL7InArchive after successful parsing<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> save hl7Message to the database<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return null if no UUID found<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return a saved new person<br/>
