...
public class HL7Util {
	 ...
	 * <p>
	 * <strong>Should</strong> fail on 19784 <strong>Should</strong> handle 197804<br/>
	 ...
	 *             <strong>Should</strong> fail on 197804110615-5 197804110615-0200
	 ...
	 *         string if exists in given string <strong>Should</strong> return timezone for givenDate
	 ...
	 * just the time, the date will remain at the epoch (e.g., January 1, 1970). Time more precise than
	 * microseconds is ignored.
	 *
	 * @param s HL7 time to be converted
	 * @return Date object set to time specified by HL7
	 * @throws HL7Exception <strong>Should</strong> fail on 197804110615 <strong>Should</strong> handle
	 *             0615 <strong>Should</strong> handle 061538 <strong>Should</strong> handle 061538.1
