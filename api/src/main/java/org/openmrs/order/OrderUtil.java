...
public class OrderUtil {
	 ...
	 * @param orderType1
	 * @param orderType2
	 * @return true if orderType2 matches or is a sub type of orderType1 <strong>Should</strong> true if
	 *         orderType2 is the same or is a subtype of orderType1 <strong>Should</strong> false if
	 *         orderType2 is neither the same nor a subtype of orderType1 return false if any is null
