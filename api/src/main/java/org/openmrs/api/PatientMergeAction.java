 ...
 * will invoke all Spring beans that implement this within the same transaction that it uses to
 * merge patients.
 * @since 2.2.0
 */
public interface PatientMergeAction {
	 ...
	 * {@link org.openmrs.api.PatientService#mergePatients(org.openmrs.Patient, org.openmrs.Patient)}
	 * method, but in the same transaction. Any thrown exception will cancel the merge
	 *
	 * @param preferred
	 * @param notPreferred
	 */
