...
public interface Credentials {
	...
	/**
	 * A string that identifies the owner of the credentials by a name. Typically in the case of a user
	 * the client would simply be identified with its username.
	 */
