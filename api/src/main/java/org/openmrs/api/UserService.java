...
public interface UserService extends OpenmrsService {
	 ...
	 * passed encoded password and salt directly to the database. The encoded password may be the
	 * full value produced by {@link org.openmrs.util.Security#encodePassword(String)} (for
