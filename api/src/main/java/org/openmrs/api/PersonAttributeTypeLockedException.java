...
public class PersonAttributeTypeLockedException extends APIException {
	...
	private static final long serialVersionUID = 4444333221L;
	...
	public PersonAttributeTypeLockedException() {
		this("Editing of person attribute type is not allowed at this time since they are currently locked. ");
	}
