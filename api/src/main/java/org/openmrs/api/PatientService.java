...
public interface PatientService extends OpenmrsService {
	 ...
	 * @should throw error when trying to delete a patient identifier type when patient identifier types are locked
	 */
	...
	/**
	 * Check if patient identifier types are locked, and if they are, throw exception during manipulation of a patient identifiera type
	 * 
