...
public class OrderServiceImpl extends BaseOpenmrsService implements OrderService, OrderNumberGenerator, GlobalPropertyListener {
	...
	/**
	 * saves the order
	 * @param Order order to save the order
	 * @param Order orderContext to save the order
	 * @return Order
	 */
	...
	/**
	 * sets the property
	 * @param Order order to set the property
	 * @param String propertyName to set the property
	 * @param Object value to set the property
	 */
	...
	/**
	 * To discontinue or revise order
	 * @param Order order to discontinue or revise order
