...
public class OrderServiceImpl extends BaseOpenmrsService implements OrderService, OrderNumberGenerator, GlobalPropertyListener {
	...
	/**
	 * the action being taken on an orderable is to check if the order is a discontinued order or revised order
	 * @param Order order to discontinue or revise for/to a patient
	 * @return true if order.getAction returns Discontinue or Revise else false
	 */
