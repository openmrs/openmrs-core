...
public interface EncounterVisitHandler {
	...
	/**
	 * Implementations of this method should look at the given <code>encounter</code> and choose whether
	 * or not it should be assigned to a {@link Visit} that is already open or if it should be part of a
	 * new visit. <br>
	 * <br>
	 * The decision of what to do is up to the handler, but it should call
	 * {@link Encounter#setVisit(Visit)} with the outcome. The visit assigned to the encounter will be
