...
/**
 * Thrown when you try to edit an order that was already saved to the database
 */
public class CannotEditAlreadyExistingOrderException extends OrderEntryException {
