...
public class SaveDbEvent<T> extends EntityEvent<T> {
	...
	/**
	 * The setting is only respected if called from a synchronous listener and before commit. Changes
	 * will be applied to the object by Hibernate before persisting. Please note that modifications to
	 * collection properties are not propagated and are read-only.
	 *
