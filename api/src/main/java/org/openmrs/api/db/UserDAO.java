...
public interface UserDAO {
	...
	/**
	 * Updates a user's login credentials. Note that there is no createLoginCredential(LoginCredential)
	 * method. Login credentials are dependent on a User already existing.
	 *
	 * @param credential
	 */
