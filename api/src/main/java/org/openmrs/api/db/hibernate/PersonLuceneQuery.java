...
public class PersonLuceneQuery {
	 ...
	 * @return the LuceneQuery that returns Persons with a soundex representation of the firstName and other defined search criteria
	 */
	public LuceneQuery<PersonName> getSoundexPersonNameSearchOnTwoNames(String n1, String n2,  Integer birthyear, boolean includeVoided, String gender) {
		
		String threeNameQuery =  TWO_NAME_QUERY.replace("n1", LuceneQuery.escapeQuery(n1))
			.replace("n2", LuceneQuery.escapeQuery(n2));
