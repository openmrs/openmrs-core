...
public interface FormDAO {
	 ...
	 * form record. If the form has been included in any other parts of the database (through a foreign
	 * key), the attempt to delete the form will violate foreign key constraints and fail.
	 *
	 ...
	 *            belong
	 * @param fieldTypes <code>Collection</code> of <code>FieldType</code> of which the requested fields
	 *            must be
	 ...
	 * @param containsAnyAnswer <code>Collection</code> of <code>FieldAnswer</code>s, any one of which a
	 *            matching field must contain (not yet implemented)
