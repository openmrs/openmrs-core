...
public interface ContextDAO {
	 ...
	 * <p>
	 * <strong>Should</strong> authenticate given username and password<br/>
	 ...
	 * <strong>Should</strong> not authenticate given null password when password in database is
	 * null<br/>
	 ...
	 * <strong>Should</strong> give identical error messages between username and password mismatch<br/>
	 ...
	 * <strong>Should</strong> throw a ContextAuthenticationException if username is an empty
	 * string<br/>
	 ...
	 * {@link Context#getAuthenticatedUser()} or
	 * {@link Context#authenticate(org.openmrs.api.context.Credentials)} methods.
	 *
	...
	/**
	 * Creates a new user. When the users are managed by a third-party authentication provider, it will
	 * happen that a successfully authenticated user still needs to be created in OpenMRS. This method
	 * is made available to authentication schemes to create new users on the fly.
	 *
