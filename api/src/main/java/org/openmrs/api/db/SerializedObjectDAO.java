...
public interface SerializedObjectDAO {
	 ...
	 * <p>
	 * <strong>Should</strong> save the passed object if supported<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all saved objects of the passed type if includeRetired<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return all saved objects with the given type and exact name<br/>
	...
	/**
	 * Retrieves all objects from the database that match the passed type and name that have been saved
	 * through serialization
	 * <p>
	 * <strong>Should</strong> return all saved objects with the given type and exact name<br/>
	 * <strong>Should</strong> return all saved objects with the given type and partial name
