...
public interface ConceptDAO {
	...
	/**
	 * Get a ConceptComplex. The Concept.getDatatype() is "Complex" and the Concept.getHandler() is the
	 * class name for the ComplexObsHandler key associated with this ConceptComplex.
	 *
	 * @param conceptId
	 ...
	 * @deprecated As of 2.5.0, this method has been deprecated in favor of
	 *             {@link #getConceptIdsByMapping(String, String, boolean)}
	 */
	@Deprecated
	 ...
	 * conceptName, bypassing any caches. This is used prior to saving an concept so that we can change
	 * the obs if need be or avoid breaking any obs referencing it.
	 *
	 ...
	 * specified term
	 * <p>
	 * <strong>Should</strong> return true if a term has a conceptMap or more using it<br/>
	 * <strong>Should</strong> return true if a term has a conceptReferenceTermMap or more using it<br/>
	 ...
	 * specified mapType
	 * <p>
	 * <strong>Should</strong> return true if a mapType has a conceptMap or more using it<br/>
	 * <strong>Should</strong> return true if a mapType has a conceptReferenceTermMap or more using
	 * it<br/>
	 ...
	 * in {@link ConceptService#saveConcept(Concept)}. It will be removed in 1.10 when we have a better
	 * way to manage flush modes.
	 *
