...
public interface ConceptService extends OpenmrsService {
	...
	/**
	 * @deprecated use {@link #getConcepts(String, Locale)} that returns a list
	 *             of ConceptSearchResults
	 */
	@Deprecated
	@Transactional(readOnly = true)
	@Authorized(PrivilegeConstants.VIEW_CONCEPTS)
	...
	@Transactional(readOnly = true)
	@Authorized(PrivilegeConstants.VIEW_CONCEPTS)
	public List<Drug> findDrugs(String phrase, boolean includeVoided)
			throws APIException;
	...
	/**
	 * Purge a ConceptDatatype. This removes the concept datatype from the
	 * database completely.
	 * 
	 * @param cd
	 ...
	 * @param name
	 * @return List<ConceptDatatype> object of ConceptDatatypes matching the
	 *         string
	 * @throws APIException
	 */
	@Transactional(readOnly = true)
	...
	/**
	 * Updates the concept set derived business table for this concept (bursting
	 * the concept sets)
	 * 
	 * @param concept
	 * @throws APIException
	 ...
	 *         concept is a valued_Coded answer
	 * @throws APIException
	 */
	@Transactional(readOnly = true)
	@Authorized(PrivilegeConstants.VIEW_CONCEPTS)
	...
	/**
	 * Return a list of concept sources currently in the database that are not
	 * voided
	 * 
	 ...
	 * {@link ConceptSource} references one and only one non-voided
	 * {@link Concept}.
	 * 
	 * @param code
	 ...
	 * @should throw exception if there is more than one non-voided concept
	 *         associated with the mappingCode
	 */
	@Transactional(readOnly = true)
	@Authorized(PrivilegeConstants.VIEW_CONCEPTS)
	 ...
	 * non-voided {@link Concept}s which contain a {@link ConceptMap} entry
	 * whose <code>sourceCode</code> is equal to the passed
	 ...
	 * @throws APIException
	 * 
	 * @should return the best matched name as the first item in the
	 *         searchResultsList
	 * 
	 * @since 1.8
	 */
	 ...
	 * <code>conceptIdStart</code> and <code>conceptIdEnd</code> (inclusive) and
	 * calls updateConceptIndexes(concept)
	 * 
	 * @param conceptIdStart
	 *            starts update with this concept_id
	 * @param conceptIdEnd
