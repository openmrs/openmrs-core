...
public class ObsArchivingTaskHandler implements TaskHandler<ObsArchivingTaskData> {
	 ...
	 * deliberately out of scope for this POC. If a {@code note} row references a voided obs, the batch
	 * will fail and {@code handleBatchFailure} will skip that row each sweep. Future options: switch
