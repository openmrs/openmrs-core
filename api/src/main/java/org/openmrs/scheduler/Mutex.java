...
/**
 * Guarantees execution of a method by one thread at a time even in a clustered environment. It uses
 * DB as a locking mechanism.
 * <p>
 * <b>Concurrent executions are not queued up. They are skipped if lock is taken.</b>
 * <p>
 * It is implemented with {@link SchedulerLock}. Please use {@link Mutex} instead of
 * {@link SchedulerLock} in case we ever need to change the implementation.
 * <p>
