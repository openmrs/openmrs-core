 ...
 * implementation via an adapter. New {@link TaskLambda}, {@link TaskLambdaService} and
 * {@link TaskData}/{@link TaskHandler} tasks are not accessible via deprecated methods e.g. 
 * <s>{@link #getScheduledTasks()}</s>. Deprecated tasks are accessible when calling new methods e.g. 
 * {@link #getTasks(TaskState)}.
 * <p>
...
public interface SchedulerService extends OpenmrsService {
	 ...
	 * @deprecated since 2.9.x use {@link #getTasks(TaskState)}
	 */
	@Deprecated
	@Authorized( { "Manage Scheduler" })
	 ...
	 * @since 2.9.x
	 */
	TaskDetails scheduleRecurrently(TaskData taskData, String cron);
	 ...
	 * @since 2.9.x
	 */
	TaskDetails scheduleRecurrently(String name, TaskData taskData, String cron);
	 ...
	 * @since 2.9.x
	 */
	TaskDetails scheduleRecurrently(TaskData taskData, String cron, ZoneId zoneId);
	 ...
	 * @since 2.9.x
	 */
	TaskDetails scheduleRecurrently(String name, TaskData taskData, String cron, ZoneId zoneId);
	 ...
	 * @since 2.9.x
	 */
	TaskDetails scheduleRecurrently(TaskData taskData, Duration interval);
	 ...
	 * @since 2.9.x
	 */
	TaskDetails scheduleRecurrently(String name, TaskData taskData, Duration interval);
