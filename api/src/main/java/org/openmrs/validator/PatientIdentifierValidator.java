...
public class PatientIdentifierValidator implements Validator {
	 ...
	 * <p>
	 * <strong>Should</strong> fail validation if PatientIdentifier is null<br/>
	 * <strong>Should</strong> pass validation if PatientIdentifier is voided<br/>
	 * <strong>Should</strong> fail validation if another patient has a matching identifier of the same
	 * type<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> fail validation if PatientIdentifierType is null<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> fail validation if identifier is blank<br/>
	 ...
	 * <strong>Should</strong> include format in error message if no formatDescription is specified<br/>
