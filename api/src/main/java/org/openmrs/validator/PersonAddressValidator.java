        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    addressTemplate = Context.getSerializationService()
                            .getDefaultSerializer()
                            .deserialize(StringEscapeUtils.unescapeHtml4(xml), AddressTemplate.class);
                }
            }
            ...
            for (String fieldName : requiredElements) {
                try {
                    ...
                    if (value == null) {
                        ...
                        blank = StringUtils.isBlank(String.valueOf(value));
                    }

                    if (blank) {
                        // required field not found or blank
                    ...
                    // wrong field declared in template (or inaccessible getter)
                    errors.reject(Context.getMessageSourceService().getMessage(
