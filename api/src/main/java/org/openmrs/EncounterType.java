...
public class EncounterType extends BaseChangeableOpenmrsMetadata {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "encounter_type_id_gen")
	@SequenceGenerator(name = "encounter_type_id_gen", sequenceName = "encounter_type_encounter_type_id_seq")
