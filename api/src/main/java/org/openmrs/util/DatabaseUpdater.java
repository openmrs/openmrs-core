...
public final class DatabaseUpdater {
	...
	public static List<String> executeChangelog(String changeLogFile, String contexts, Map<String, Object> userInput,
		...
		class OpenmrsUpdateVisitor extends UpdateVisitor {
			
			private ChangeSetExecutorCallback callback;
			
			private int numChangeSetsToRun;
			
			OpenmrsUpdateVisitor(Database database, ChangeSetExecutorCallback callback, int numChangeSetsToRun) {
				super(database);
	...
	private static void mergeDefaultRuntimeProperties(Properties runtimeProperties) {
		...
		// it isn't already
		Collection<Object> runtimePropertyKeys = new HashSet<Object>();
	...
	public static Connection getConnection() throws Exception {
		...
		if (url.contains("mysql") && !url.contains("InnoDB")) {
            url += "&sessionVariables=storage_engine=InnoDB";
		}
	 ...
	 */
	public static void reportUpdateWarnings(Collection<String> warnings) {
