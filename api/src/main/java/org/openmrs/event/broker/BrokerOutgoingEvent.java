 ...
 * <p>
 * If payload is an {@code InputStream}, it will be passed to a broker without any serialization,
 * otherwise the payload should be serializable to JSON with the default ObjectMapper
 ...
 * brokers to consume the stream's content, as each will receive a new, independent
