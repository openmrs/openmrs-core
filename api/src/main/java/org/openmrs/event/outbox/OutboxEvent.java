...
public class OutboxEvent extends BaseOpenmrsObject implements Auditable {
	 ...
	 * {@code creator}/{@code changedBy} associations are intentionally left untouched: the id never changes
	 * for the same row, and copying lazy proxies across sessions risks
