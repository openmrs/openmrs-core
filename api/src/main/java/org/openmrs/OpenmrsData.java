...
public interface OpenmrsData extends Auditable, Voidable {
	...
	/**
	 * @deprecated As of version 2.2, OpenmrsData is immutable by default, it's up to the subclasses to
	 *             make themselves mutable by extending BaseChangeableOpenmrsData, this method will be
	 *             removed in 2.3
	 */
	@Override
	@Deprecated
