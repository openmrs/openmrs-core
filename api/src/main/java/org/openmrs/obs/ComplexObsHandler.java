...
public interface ComplexObsHandler {
	...
	/**
	 * Save a complex obs. This extracts the ComplexData from an Obs, stores it to a location determined
	 * by the handler, and returns the Obs with the ComplexData nullified.
	 *
	 * @param obs
	...
	/**
	 * Fetches the ComplexData from the location indicated from Obs.value_complex, attaches ComplexData
	 * onto the Obs and returns the Obs. <br>
