...
public @interface Logging {
	...
	/**
	 * If set to true, the annotated method will not print out the contents of the arguments every time
	 * this method is accessed and logged. Defaults to false
	 *
	 ...
	 * defined if the <code>Logging</code> annotation has set {@link #ignoreAllArgumentValues()} to true
	 *
