...
public class ModifyColumnGenerator extends AbstractSqlGenerator<ModifyColumnStatement> {
  ...
  /**
   * Whether the ALTER command can take things like "DEFAULT VALUE" or "PRIMARY
   * KEY" as well as type changes
   *
   * @param database
  ...
  /**
   * @return the string that comes before the column type definition (like 'set
   *         data type' for derby or an open parentheses for Oracle)
   */
  ...
  /**
   * @return the string that comes after the column type definition (like a close
