 ...
 */
class PersonNameGlobalPropertyListener : GlobalPropertyListener {
    
    override fun supportsPropertyName(propertyName: String): Boolean {
        return OpenmrsConstants.GLOBAL_PROPERTY_LAYOUT_NAME_FORMAT == propertyName
    }
    
    override fun globalPropertyChanged(newValue: GlobalProperty) {
        PersonName.setFormat(newValue.propertyValue)
    }
