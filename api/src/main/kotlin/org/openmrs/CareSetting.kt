...
class CareSetting() : BaseChangeableOpenmrsMetadata() {
    ...
    var careSettingId: Int? = null
    
    @Enumerated(EnumType.STRING)
    @JdbcTypeCode(SqlTypes.VARCHAR)
    @Column(name = "care_setting_type", length = 50, nullable = false)
    var careSettingType: CareSettingType? = null
    
    constructor(name: String?, description: String?, careSettingType: CareSettingType?) : this() {
        this.name = name
