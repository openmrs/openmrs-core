...
/**
 * This class holds the minimal amount of data necessary to change a user's password
 * without using a PreparedStatement or putting the password in the User class.
 * 
 * This should never be used by anything except for UserDAO and UserService mthods that change passwords. 
 */
public class LoginCredential implements Synchronizable {
	...
	/**
     * @param lastRecordGuid the lastRecordGuid to set
     */
