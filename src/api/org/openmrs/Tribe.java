...
/**
 * @deprecated This object is no longer supported.  This functionality
 * has been replaced by the Tribe module.  The installation of that
 * module converts this tribe patient attribute to a PersonAttribute
 * and all values are copied over
 * 
 */
@Deprecated // duplicate this tag so the module can know if this class is deprecated
