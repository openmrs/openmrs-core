...
public class LogicQueryBaseParser extends antlr.LLkParser implements LogicQueryBaseParserTokenTypes {
								...
								case LITERAL_SORT: {
									{
										...
										match(LITERAL_SORT);
										{
											if ((LA(1) == TIME || LA(1) == LITERAL_DATA)) {
												sort_option();
												astFactory.addASTChild(currentAST, returnAST);
											} else if ((_tokenSet_15.member(LA(1)))) {} else {
												throw new NoViableAltException(LT(1), getFilename());
											}
				...
				case INTLIT: {
					{
						...
						match(INTLIT);
						{
							...
							} else if ((_tokenSet_26.member(LA(1)))) {} else {
								throw new NoViableAltException(LT(1), getFilename());
							}
				...
				} else if ((_tokenSet_7.member(LA(1)))) {
					{
						...
						astFactory.addASTChild(currentAST, returnAST);
						{
							if ((LA(1) == INTLIT)) {
								...
								match(INTLIT);
							} else if ((_tokenSet_7.member(LA(1)))) {} else {
								throw new NoViableAltException(LT(1), getFilename());
							}
	...
	public static final String[] _tokenNames = { "<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD", "\"and\"", "WEIRD_IDENT",
	        ...
	        "\"*\"", "\"/\"", "TERM_LITERAL", "SEMI", "ARDEN_CURLY_BRACKETS", "NOT_COMMENT", "COMMENT", "ML_COMMENT", "WS",
	        "BECOMES", "COLON", "LBRACKET", "RBRACKET", "DOTDOT", "NOT_EQUALS", "PLUS", "SINGLE_QUOTE", "LCURLY", "RCURLY" };
