//$ANTLR 2.7.6 (2005-12-22): "LogicQueryParser.g" -> "LogicQueryLexer.java"$
...
/*************************************************************************************/
public class LogicQueryLexer extends antlr.CharScanner implements LogicQueryBaseParserTokenTypes, TokenStream
{
	public LogicQueryLexer(InputStream in) {
		this(new ByteBuffer(in));
	}
	public LogicQueryLexer(Reader in) {
		this(new CharBuffer(in));
	}
	public LogicQueryLexer(InputBuffer ib) {
		this(new LexerSharedInputState(ib));
	}
	@SuppressWarnings("unchecked")
	public LogicQueryLexer(LexerSharedInputState state) {
		super(state);
		...
		literals.put(new ANTLRHashString("LIST", this), new Integer(127));
		...
		literals.put(new ANTLRHashString("STRING", this), new Integer(126));
		...
		literals.put(new ANTLRHashString("seconds", this), new Integer(134));
		...
		literals.put(new ANTLRHashString("minutes", this), new Integer(133));
		...
		literals.put(new ANTLRHashString("t", this), new Integer(114));
		...
		literals.put(new ANTLRHashString("Z", this), new Integer(119));
		...
		literals.put(new ANTLRHashString("SEQTO", this), new Integer(157));
		...
		literals.put(new ANTLRHashString("DURATION", this), new Integer(125));
		literals.put(new ANTLRHashString("OBJECT", this), new Integer(128));
		...
		literals.put(new ANTLRHashString("MERGE", this), new Integer(154));
		literals.put(new ANTLRHashString("GE", this), new Integer(144));
		...
		literals.put(new ANTLRHashString("DATA", this), new Integer(156));
		...
		literals.put(new ANTLRHashString("minute", this), new Integer(132));
		...
		literals.put(new ANTLRHashString("SORT", this), new Integer(155));
		literals.put(new ANTLRHashString(".", this), new Integer(115));
		literals.put(new ANTLRHashString("else", this), new Integer(58));
		literals.put(new ANTLRHashString(":", this), new Integer(112));
		...
		literals.put(new ANTLRHashString("LE", this), new Integer(142));
	}
