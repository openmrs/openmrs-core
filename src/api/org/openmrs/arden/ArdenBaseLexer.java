...
public ArdenBaseLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("PRESENT", this), new Integer(129));
	...
	literals.put(new ANTLRHashString("priority", this), new Integer(152));
	literals.put(new ANTLRHashString("LIST", this), new Integer(135));
	literals.put(new ANTLRHashString("before", this), new Integer(17));
	literals.put(new ANTLRHashString("CALL", this), new Integer(154));
	...
	literals.put(new ANTLRHashString("EVENT", this), new Integer(126));
	literals.put(new ANTLRHashString("expired", this), new Integer(98));
	literals.put(new ANTLRHashString("specialist", this), new Integer(92));
	...
	literals.put(new ANTLRHashString("production", this), new Integer(95));
	literals.put(new ANTLRHashString("months", this), new Integer(50));
	literals.put(new ANTLRHashString("+", this), new Integer(107));
	literals.put(new ANTLRHashString("STRING", this), new Integer(134));
	literals.put(new ANTLRHashString("are", this), new Integer(7));
	literals.put(new ANTLRHashString("purpose", this), new Integer(111));
	literals.put(new ANTLRHashString("maximum", this), new Integer(36));
	literals.put(new ANTLRHashString("exist", this), new Integer(44));
	literals.put(new ANTLRHashString("knowledge", this), new Integer(78));
	literals.put(new ANTLRHashString("NUMBER", this), new Integer(132));
	literals.put(new ANTLRHashString("seconds", this), new Integer(143));
	literals.put(new ANTLRHashString("author", this), new Integer(90));
	...
	literals.put(new ANTLRHashString("minutes", this), new Integer(141));
	literals.put(new ANTLRHashString("OCCUR", this), new Integer(144));
	...
	literals.put(new ANTLRHashString("explanation", this), new Integer(112));
	...
	literals.put(new ANTLRHashString("NULL", this), new Integer(130));
	literals.put(new ANTLRHashString("date", this), new Integer(93));
	literals.put(new ANTLRHashString("validation", this), new Integer(94));
	literals.put(new ANTLRHashString("evoke", this), new Integer(153));
	...
	literals.put(new ANTLRHashString("version", this), new Integer(87));
	...
	literals.put(new ANTLRHashString("DURATION", this), new Integer(133));
	literals.put(new ANTLRHashString("OBJECT", this), new Integer(136));
	...
	literals.put(new ANTLRHashString("ASTM-E", this), new Integer(85));
	literals.put(new ANTLRHashString("first", this), new Integer(39));
	literals.put(new ANTLRHashString("EQ", this), new Integer(157));
	literals.put(new ANTLRHashString("OCCURRED", this), new Integer(150));
	literals.put(new ANTLRHashString("days", this), new Integer(47));
	literals.put(new ANTLRHashString("Any", this), new Integer(155));
	literals.put(new ANTLRHashString("data", this), new Integer(63));
	literals.put(new ANTLRHashString("second", this), new Integer(142));
	literals.put(new ANTLRHashString("hour", this), new Integer(138));
	literals.put(new ANTLRHashString("keywords", this), new Integer(113));
	literals.put(new ANTLRHashString("hours", this), new Integer(139));
	literals.put(new ANTLRHashString("OCCURS", this), new Integer(147));
	literals.put(new ANTLRHashString("SUPPORT", this), new Integer(115));
	...
	literals.put(new ANTLRHashString("T", this), new Integer(104));
	literals.put(new ANTLRHashString("research", this), new Integer(96));
	literals.put(new ANTLRHashString("mlmname", this), new Integer(69));
	literals.put(new ANTLRHashString("minute", this), new Integer(140));
	literals.put(new ANTLRHashString("were", this), new Integer(9));
	literals.put(new ANTLRHashString("day", this), new Integer(48));
	literals.put(new ANTLRHashString("data-driven", this), new Integer(120));
	...
	literals.put(new ANTLRHashString("data_driven", this), new Integer(121));
	...
	literals.put(new ANTLRHashString("testing", this), new Integer(97));
