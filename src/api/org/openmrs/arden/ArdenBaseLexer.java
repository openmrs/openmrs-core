...
public ArdenBaseLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("LIST", this), new Integer(128));
	literals.put(new ANTLRHashString("before", this), new Integer(16));
	literals.put(new ANTLRHashString("TIME", this), new Integer(125));
	literals.put(new ANTLRHashString("CALL", this), new Integer(149));
	...
	literals.put(new ANTLRHashString("STRING", this), new Integer(127));
	...
	literals.put(new ANTLRHashString("Occur", this), new Integer(140));
	literals.put(new ANTLRHashString("EQUAL", this), new Integer(131));
	literals.put(new ANTLRHashString("than", this), new Integer(14));
	literals.put(new ANTLRHashString("explanation", this), new Integer(104));
	...
	literals.put(new ANTLRHashString("NULL", this), new Integer(122));
	literals.put(new ANTLRHashString("date", this), new Integer(86));
	literals.put(new ANTLRHashString("validation", this), new Integer(87));
	literals.put(new ANTLRHashString("evoke", this), new Integer(148));
	...
	literals.put(new ANTLRHashString("Z", this), new Integer(101));
	literals.put(new ANTLRHashString("last", this), new Integer(37));
	literals.put(new ANTLRHashString("GT", this), new Integer(156));
	literals.put(new ANTLRHashString("arden", this), new Integer(77));
	literals.put(new ANTLRHashString("the", this), new Integer(13));
	literals.put(new ANTLRHashString("citations", this), new Integer(106));
	literals.put(new ANTLRHashString("urgency", this), new Integer(164));
	literals.put(new ANTLRHashString("institution", this), new Integer(82));
	...
	literals.put(new ANTLRHashString("version", this), new Integer(80));
	...
	literals.put(new ANTLRHashString("DURATION", this), new Integer(126));
	literals.put(new ANTLRHashString("OBJECT", this), new Integer(129));
	...
	literals.put(new ANTLRHashString("MERGE", this), new Integer(165));
	literals.put(new ANTLRHashString("GE", this), new Integer(160));
	literals.put(new ANTLRHashString("BOOLEAN", this), new Integer(123));
	literals.put(new ANTLRHashString("if", this), new Integer(26));
	literals.put(new ANTLRHashString("DATA", this), new Integer(167));
	literals.put(new ANTLRHashString("min", this), new Integer(34));
	literals.put(new ANTLRHashString("ASTM-E", this), new Integer(78));
	literals.put(new ANTLRHashString("first", this), new Integer(38));
	literals.put(new ANTLRHashString("EQ", this), new Integer(152));
	literals.put(new ANTLRHashString("OCCURRED", this), new Integer(145));
	...
	literals.put(new ANTLRHashString("second", this), new Integer(136));
	literals.put(new ANTLRHashString("hour", this), new Integer(132));
	literals.put(new ANTLRHashString("keywords", this), new Integer(105));
	literals.put(new ANTLRHashString("hours", this), new Integer(133));
	literals.put(new ANTLRHashString("OCCURS", this), new Integer(142));
	literals.put(new ANTLRHashString("SUPPORT", this), new Integer(107));
	literals.put(new ANTLRHashString("z", this), new Integer(102));
	literals.put(new ANTLRHashString("Occurred", this), new Integer(146));
	...
	literals.put(new ANTLRHashString("data-driven", this), new Integer(112));
	...
	literals.put(new ANTLRHashString("SORT", this), new Integer(166));
	literals.put(new ANTLRHashString(".", this), new Integer(98));
	literals.put(new ANTLRHashString("else", this), new Integer(57));
	literals.put(new ANTLRHashString(":", this), new Integer(95));
	...
	literals.put(new ANTLRHashString("data_driven", this), new Integer(113));
	...
	literals.put(new ANTLRHashString("Occurs", this), new Integer(143));
	literals.put(new ANTLRHashString("testing", this), new Integer(90));
