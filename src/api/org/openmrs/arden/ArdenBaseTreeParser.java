...
public ArdenBaseTreeParser() {
	...
	public final String  data(AST _t,
		...
		try {      // for error handling
			...
			do {
				...
				case CALL:
				{
					System.err.println("-----------Starting Data CALL -------"); a = "" ;
				...
				default:
					...
					if ((_tokenSet_0.member(_t.getType()))) {
						System.err.println("-----------Starting Read -------");obj.InitEvaluateList("data",null);
						s=readAST(_t,obj, s);
						_t = _retTree;
						obj.AddToEvaluateList("data",s);System.err.println("\n");System.err.println("-----------End Read -------");
					}
						...
						match(_t,ENDIF);
						_t = _t.getFirstChild();
						System.err.println("ENDIF FOUND");a = "ENDIF"; obj.AddToEvaluateList("data",a);
						_t = __t341;
	...
	public final String  dataIfAST(AST _t,
		...
		try {      // for error handling
			...
			match(_t,IF);
			_t = _t.getFirstChild();
			obj.InitEvaluateList("data","IF");obj.AddToEvaluateList("data","IF");
	...
	public final String  callSectionAST(AST _t,
		MLMObject obj, String key,String section
	) throws RecognitionException {
		String s="";
	...
	public final String  of_read_func_opAST(AST _t,
		...
		try {      // for error handling
			...
			case EXISTS:
			{
				...
				obj.AddToEvaluateList("data","EXIST");System.err.println("ReadType = Exist");
				break;
			}
			case AVG:
			case AVERAGE:
			{
				...
				obj.AddToEvaluateList("data","AVG");System.err.println("ReadType = Average");
				break;
			}
			case COUNT:
			{
				...
				obj.AddToEvaluateList("data","COUNT");System.err.println("ReadType = Count");
				break;
			}
			case SUM:
			{
				...
				obj.AddToEvaluateList("data","SUM");System.err.println("ReadType = Sum");
				break;
			}
			case MEDIAN:
			{
				...
				obj.AddToEvaluateList("data","MEDIAN");System.err.println("ReadType = Median");
				break;
			}
			default:
			{
	...
	public final String  of_noread_func_opAST(AST _t,
		...
		try {      // for error handling
			...
			case ANY:
			{
				...
				obj.AddToEvaluateList("data","ANY");System.err.println("Any of");
				break;
			}
			default:
			{
...
/********************LOGIC***********************************/
		...
		try {      // for error handling
			...
			do {
				...
				case ENDIF:
				{
					...
					match(_t,ENDIF);
					_t = _t.getFirstChild();
					System.err.println("ENDIF FOUND");a = "ENDIF"; obj.AddToEvaluateList("logic",a);
					_t = __t433;
					_t = _t.getNextSibling();
					break;
				}
				case CONCLUDE:
				{
					System.err.println("-----------Starting CONCLUDE -------");obj.InitEvaluateList("logic",null); a = "Conclude_" + Integer.toString(i);
					concludeAST(_t,obj, a);
					_t = _retTree;
					System.err.println("\n");System.err.println("-----------End CONCLUDE -------");
					break;
				...
				case CALL:
				{
					System.err.println("-----------Starting CALL -------");obj.InitEvaluateList("logic",null); a = "" ;
					callSectionAST(_t,obj, a,"logic");
					_t = _retTree;
					System.err.println("\n");System.err.println("-----------End CALL -------");
					i++;
	...
	public final String  ifAST(AST _t,
		...
		try {      // for error handling
			...
			match(_t,IF);
			_t = _t.getFirstChild();
			obj.InitEvaluateList(section,"IF"); obj.AddToEvaluateList(section,"IF");
	...
	public final String  callStringAST(AST _t,
		String section, MLMObject obj, String instr
	) throws RecognitionException {
		String s="";
	...
	public final String  expr_comparisonAST(AST _t,
		String section,MLMObject obj
	) throws RecognitionException {
		String s="";
	...
	public final String  simple_comp_opAST(AST _t,
		String section,MLMObject obj, String key
	) throws RecognitionException {
		String s="";
	...
	public final String  expr_notAST(AST _t,
		String section,MLMObject obj
	) throws RecognitionException {
		String s="";
	...
	public final String  expr_andAST(AST _t,
		String section,MLMObject obj
	) throws RecognitionException {
		String s="";
	...
	public final String  expr_orAST(AST _t,
		String section,MLMObject obj
	) throws RecognitionException {
		String s="";
		...
		try {      // for error handling
			...
			do {
				...
				case IF:
				{
					...
					_t = _retTree;
					System.err.println("-----------Starting CALL -------"); obj.InitEvaluateList("action",null); a = "" ;
				...
				case ENDIF:
				{
					...
					match(_t,ENDIF);
					_t = _t.getFirstChild();
					System.err.println("ENDIF FOUND");a = "ENDIF"; obj.AddToEvaluateList("action",a);
					_t = __t527;
					_t = _t.getNextSibling();
					break;
				}
...
/***********************LIBRARY*******************************************/
	...
	public final String  dateAST(AST _t,
