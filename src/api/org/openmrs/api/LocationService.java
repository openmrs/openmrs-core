...
public interface LocationService extends OpenmrsService {
	 ...
	 * database.
	 * 
	 * This is set by spring in the applicationContext-service.xml file
	 * 
	 * @param dao
	 */
	 ...
	 * @returns Location object that has location.locationId =
	...
	@Transactional(readOnly = true)
	@Authorized( { OpenmrsConstants.PRIV_VIEW_LOCATIONS })
	public List<Location> getLocations(String nameFragment)
	        throws APIException;
