...
public interface FormService extends OpenmrsService {
	 ...
	 * then this returns the one with the highest version (sorted alphabetically)
	 * 
	 ...
	 * (The precise fuzzy matching algorithm is not specified.)
	 * 
	 ...
	 * @return
	 * @throws APIException
	 * @deprecated use {@link #getAllForms()} or {@link #getPublishedForms()} or {@link #getForms(String, Boolean, Collection, Boolean, Collection, Collection)}
	 */
	@Transactional(readOnly=true)
	@Authorized(OpenmrsConstants.PRIV_VIEW_FORMS)
	...
	/** 
	 * Retires the Form, leaving it in the database, but removing it
	 * from data entry screens
	 * 
	 ...
	 * It will fail if this form has already been used to create Encounters 
	 * 
	 * @param form
	 * @return
	 * @throws APIException
	...
	/**
	 * Find all Fields whose names are similar to or contain the given phrase. (The exact similarity algorithm is unspecified.)
	 * (includes retired fields)
	 * 
	...
	/**
	 * Completely removes a Field from the database. Not reversible.
	 * !! WARNING: calling this with cascade=true can be very destructive !!
	 * 
	 * @param field the Field to purge
	...
	/**
	 * @deprecated use {@link #getForms(String, Boolean, Collection, Boolean, Collection, Collection)}
	...
	/**
	 * Deletes the given field type from the database. This should not 
	 * be done.  It is preferred to just retired this field type with
