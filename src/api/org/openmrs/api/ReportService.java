...
public interface ReportService {
	 ...
	 * @param reportSchema - The {@link ReportSchema} is the main report definition, and contains all 
	 * 						 indicator and required parameter definitions
	 * @param inputCohort - If not null, this will limit the Report evaluation to only those patients in this {@link Cohort}.
	 * 						If null, all patients are evaluated.
	 ...
	 * 
	 * @param Integer reportSchemaId The ReportSchema id
	...
	/**
	 * Save or update the given <code>ReportSchema</code> in the database.
	 * If this is a new ReportSchema, the returned ReportSchema will have
	 * a new {@link ReportSchema#getReportSchemaId()} inserted into it that
	 * was generated by the database
	 * 
	 * @param ReportSchema reportSchema The <code>ReportSchema</code> to save or update
	 * @return the <code>ReportSchema</code> that was saved or updated
	 * @throws APIException
	 */
	 ...
	 * 
	 * @param ReportSchema reportSchema The <code>ReportSchema</code> to remove from the system
	 * @throws APIException
	 */
	...
	/**
	 * Returns a List of {@link RenderingMode}s that the passed {@link ReportSchema} supports,
