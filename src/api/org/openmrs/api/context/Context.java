...
public class Context {
	 ...
	 * perform authentication/authorization checks. TODO Make thread-safe
	 * because this might be accessed by several thread at the same time. Making
	 * this thread safe might make this a bottleneck.
	 * 
	 * @param userContext
	 */
	public static void setUserContext(UserContext ctx) {
		if (log.isTraceEnabled()) log.trace("Setting user context " + ctx);
	...
	public static void clearUserContext() {
		if (log.isTraceEnabled()) log.trace("Clearing user context " + userContextHolder.get());
	...
	public static UserContext getUserContext() {
		...
		if (log.isTraceEnabled()) log.trace("Getting user context " + arr + " from userContextHolder " + userContextHolder);
	...
	private static ServiceContext getServiceContext() {
		...
		if (log.isTraceEnabled()) log.trace("serviceContext: " + serviceContext);
	...
	public static void authenticate(String username, String password) throws ContextAuthenticationException {
		if (log.isDebugEnabled()) log.debug("Authenticating with username: " + username);
	...
	public static void becomeUser(String systemId) throws ContextAuthenticationException {
		if (log.isInfoEnabled()) log.info("systemId: " + systemId);
	...
	public static Properties getRuntimeProperties() {
		if (log.isTraceEnabled()) log.trace("getting runtime properties. size: " + runtimeProperties.size());
	...
	public static MessageService getMessageService() {
		...
		try {
			...
			if (ms.getMessagePreparator() == null) ms.setMessagePreparator(getMessagePreparator());

			if (ms.getMessageSender() == null) ms.setMessageSender(getMessageSender());
	...
	public static void logout() {
		if (log.isDebugEnabled()) log.debug("Logging out : " + getAuthenticatedUser());
	...
	public static void requirePrivilege(String privilege) throws ContextAuthenticationException {
		if (!hasPrivilege(privilege)) throw new ContextAuthenticationException();
	}
	...
	/**
	 * Used to clear cached objects out of a session in the middle of a unit of
	 * work.
	 */
	...
	/**
	 * Adds an AOP advisor around the given Class <code>cls</code> Advisors can
	 * wrap around a method and effect the method before or after
	 * 
	 * @param cls
	 * @param advisor
	 */
	...
	/**
	 * Adds an AOP advice object around the given Class <code>cls</code> Advice
	 * comes in the form of before or afterReturning methods
	 * 
	 * @param cls
	 * @param advice
	 */
	 ...
	 * global_property.property = 'database_version' Sets
	 * OpenmrsConstants.DATABASE_VERSION accordingly
	 */
	...
	/**
	 * Get a piece of information for the currently authenticated user. This
	 * information is stored only temporarily. When a new module is loaded or
	 * the server is restarted, this information will disappear. If there is not
	 * information by this key, null is returned TODO: This needs to be
	 * refactored/removed
	 * 
	...
	/**
	 * Set a piece of information for the currently authenticated user. This
	 * information is stored only temporarily. When a new module is loaded or
	 * the server is restarted, this information will disappear TODO: This needs
