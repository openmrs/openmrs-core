 ...
 * Concepts, Drugs, Concept Proposals, and all other things 'Concept'.<br/>
 * 
 * <br/>
...
public interface ConceptService extends OpenmrsService {
	 ...
	 * If this is a new concept, the returned concept will have
	 * a new {@link Concept#getConceptId()} inserted into it that
	 ...
	 * If this is a new drug, the returned drug object will have
	 * a new {@link Drug#getDrugId()} inserted into it that
	 * was generated by the database
	 * 
