...
public class ObsServiceImpl extends BaseOpenmrsService implements ObsService {
	...
	/**
	 * Convenience method for turning a string like
	 * "location.locationId asc, obs.valueDatetime desc" into a list of strings to sort on
     * 
     * @param sort string
    ...
    public MimeType getMimeTypeByGuid(String guid) throws APIException {
		return dao.getMimeTypeByGuid(guid);
    }
