...
/**
 * Contains methods pertaining to creating/deleting/voiding Orders and DrugOrders
 * 
 * Use:<br/>
 * <pre>
...
public interface OrderService extends OpenmrsService {
	...
	/**
	 * Setter for the Order data access object.  The dao is used for 
	 * saving and getting orders to/from the database
	 * 
	 ...
	 * be used unless desperately needed.  Most orders should just be voided.
	 * See {@link #voidOrder(Order, String)}
	 * 
	...
	/**
	 * Mark an order as voided. This functionally removes the Order from
	 * the system while keeping a semblance 
	 * @param voidReason 
	 * @param Order to void
	...
	/**
	 * Mark the given order as discontinued.  This should be used when patients
	 * are no longer on this Order.  If this is was invalid Order, the 
	 * {@link #voidOrder(Order, String)} method should probably be used.
	 * 
	 ...
	 * @param orderClassType The class of Order to fetch (Currently only org.openmrs.Order 
	 * 		or org.openmrs.DrugOrder)
	...
	/**
	 * @deprecated use {@link #getOrder(Integer, Class)} with DrugOrder.class as second parameter instead
	 */
	@Transactional(readOnly = true)
	@Authorized(OpenmrsConstants.PRIV_VIEW_ORDERS)
	 ...
	 * @param orderClassType The type of Order to get (currently only options are Order and DrugOrder)
	...
	/**
	 * @deprecated this method would return a very large list for most systems
	 * 		and doesn't make sense to be used. If _all_ Orders are really what
	 * 		is wanted, use {@link #getOrders(Class, List, List, org.openmrs.api.OrderService.ORDER_STATUS, List, List, List)} 
	...
	/**
	 * @deprecated use {@link #getDrugOrdersByPatient(Patient, org.openmrs.api.OrderService.ORDER_STATUS)}
	 */
	@Transactional(readOnly=true)
	@Authorized(OpenmrsConstants.PRIV_VIEW_ORDERS)
	...
	/**
	 * @deprecated use {@link #getDrugOrdersByPatient(Patient, org.openmrs.api.OrderService.ORDER_STATUS, boolean)}
	 */
	@Transactional(readOnly=true)
	@Authorized(OpenmrsConstants.PRIV_VIEW_ORDERS)
	...
	/**
	 * Completely delete the order type from the system.  If data has been
	 * stored using this orderType, an exception will be thrown.  In that 
	 * case, consider using the #retiredOrderType(OrderType, String) method
	 * 
	 * @param orderType
	 * @throws APIException
	 */
	...
	/**
	 * This method essentially takes the given <code>orderType</code> out of
	 * active use in OpenMRS.  All references to this order
	 * type will remain in place.  Future use of this order type
	 * are discouraged.
	 * 
	...
	/**
	 * Get all order types, only showing ones not marked as retired if
	 ...
	 * 
	 * See xml elements after the "STANDARD REGIMENS" comment in the web
	 * spring servlet: /web/WEB-INF/openmrs-servlet.xml
	 * 
	 * (These really should be in the non-web spring app context:
	...
	/**
	 * @deprecated use {@link org.openmrs.order.OrderUtil#getDrugSetsByDrugSetIdList(List, String, String)}
	 */
	@Transactional(readOnly=true)
	@Authorized(OpenmrsConstants.PRIV_VIEW_ORDERS)
	...
	/**
	 * @deprecated use {@link org.openmrs.order.OrderUtil#discontinueDrugSet(Patient, String, Concept, Date)}
	 */
	@Authorized(OpenmrsConstants.PRIV_EDIT_ORDERS)
	...
	/**
	 * @deprecated use {@link org.openmrs.order.OrderUtil#voidDrugSet(Patient, String, String, org.openmrs.api.OrderService.ORDER_STATUS)}
	 */
	@Authorized(OpenmrsConstants.PRIV_DELETE_ORDERS)
	...
	/**
	 * @deprecated use {@link org.openmrs.order.OrderUtil#discontinueAllOrders(Patient, Concept, Date)}
	 */
	@Authorized(OpenmrsConstants.PRIV_EDIT_ORDERS)
