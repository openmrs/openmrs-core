...
/**
 * This is a specific serialization strategy developed so that the OpenMRS
 * objects that happen to be proxied by Hibernate will be serialized correctly.
 * 
 * Use:
 * 
 * <code>
...
public class OpenmrsCycleStrategy extends CycleStrategy {
	...
	/**
	 * If true, the serialization will be kept to a minimum
	 * as decided in the methods marked with @Replace annotations
	 */
	...
	/**
	 * Custom constructor to set whether this serialization will be a 
	 * short one or not.  The 
	...
	/**
     * @see org.simpleframework.xml.graph.CycleStrategy#setRoot(java.lang.Class, java.lang.Object, org.simpleframework.xml.stream.NodeMap, java.util.Map)
     */
	@Override
