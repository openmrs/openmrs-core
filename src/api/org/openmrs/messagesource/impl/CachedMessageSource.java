...
/**
 * A MutableMessageSource backed by a localized map of PresentationMessageCollections,
 * providing in-memory storage of PresentationMessages. 
 * 
 * Useful for temporary storage, as a cache for other sources, and for testing.
 *  
 */
public class CachedMessageSource extends AbstractMessageSource implements MutableMessageSource {
	 ...
	 */
	public void publishProperties(Properties arg0, String arg1, String arg2,
