 ...
 */
public class FrequencyDistributionFormatterHTML implements OutputFormatter {
	...
	/* (non-Javadoc)
	 * @see org.openmrs.reporting.Formatter#canFormat(java.lang.Class)
	 */
	public boolean canFormat(Class inputClass) {
		try {
			return (Class.forName("java.util.Map<Object,Number>").isAssignableFrom(inputClass)) || (Class.forName("java.util.List<Object[]>").isAssignableFrom(inputClass));
