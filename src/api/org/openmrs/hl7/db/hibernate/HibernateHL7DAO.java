...
public class HibernateHL7DAO implements HL7DAO {
	...
	public HL7Source getHL7Source(Integer hl7SourceId) throws DAOException {
		...
		HL7Source hl7Source;
		hl7Source = (HL7Source) session.get(HL7Source.class,
				hl7SourceId);
	...
	public Collection<HL7Source> getHL7Sources() throws DAOException {
		...
		return session.createQuery("from HL7Source order by hL7SourceId").list();
	}
	...
	public HL7InQueue getHL7InQueue(Integer hl7InQueueId) throws DAOException {
		...
		hl7InQueue = (HL7InQueue) session.get(HL7InQueue.class,
				hl7InQueueId);
	...
	public Collection<HL7InQueue> getHL7InQueues() throws DAOException {
		...
		return session.createQuery("from HL7InQueue order by hl7InQueueId").list();
	}
	...
	public HL7InQueue getNextHL7InQueue() throws DAOException {
		...
		return (HL7InQueue) session.createQuery("from HL7InQueue as hiq where hiq.HL7InQueueId = (select min(HL7InQueueId) from HL7InQueue)").uniqueResult();
	}
	...
	public Collection<HL7InArchive> getHL7InArchives() throws DAOException {
		...
		return session.createQuery("from HL7InArchive order by hL7InArchiveId").list();
	}
	...
	public HL7InError getHL7InError(Integer hl7InErrorId) throws DAOException {
		...
		hl7InError = (HL7InError) session.get(HL7InError.class,
				hl7InErrorId);
	...
	public Collection<HL7InError> getHL7InErrors() throws DAOException {
		...
		return session.createQuery("from HL7InError order by hL7InErrorId").list();
	}
