...
public class HL7Util {
	...
	public final static String LOCAL_TIMEZONE_OFFSET = new SimpleDateFormat("Z")
			.format(new Date());

	/**
	 * Converts an HL7 timestamp into a java.util.Date object.  HL7 timestamps
	 * can be created with varying levels of precision &mdash; e.g., just the year
	 * or just the year and month, etc.  Since java.util.Date cannot store a partial
	 * value, we fill in defaults like January, 01 at midnight within the current
	 * timezone.
	 * 
	...
	/**
	 * Convenience method for parsing HL7 dates (treated just like a
	 * timestamp with only year, month, and day specified)
	 * 
	...
	/**
	 * Converts an HL7 time into a java.util.Date object.  Since the java.util.Date
	 * object cannot store just the time, the date will remain at the epoch
	 * (e.g., January 1, 1970).  Time more precise than microseconds is ignored.
	 * 
