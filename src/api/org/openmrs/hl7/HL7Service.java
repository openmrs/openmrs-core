...
public interface HL7Service extends OpenmrsService {
	 ...
	 */
	@Authorized(value = { HL7Constants.PRIV_UPDATE_HL7_IN_QUEUE,
	        HL7Constants.PRIV_ADD_HL7_IN_QUEUE }, requireAll = false)
	 ...
	 * @throws APIException
	 */
	@Authorized(value = { HL7Constants.PRIV_UPDATE_HL7_IN_ARCHIVE,
	        HL7Constants.PRIV_ADD_HL7_IN_ARCHIVE }, requireAll = false)
	 ...
	 * @throws APIException
	 */
	@Authorized(value = { HL7Constants.PRIV_UPDATE_HL7_IN_EXCEPTION,
	        HL7Constants.PRIV_ADD_HL7_IN_EXCEPTION }, requireAll = false)
	...
	/**
	 * This method is called after an encounter and its obs are created. This
	 * method can be removed once we have obs groups being created correctly
	 * 
	 * @param encounter
	 * 
