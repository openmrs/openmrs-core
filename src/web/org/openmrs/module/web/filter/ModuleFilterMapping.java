...
/**
 * This class represents the mapping of a Filter to
 * a collection of Servlets and URLs
 */
public class ModuleFilterMapping implements Serializable {
    ...
    /**
     * Return <code>true</code> if the passed Filter passes one or more filter mappings
     * otherwise, return <code>false</code>.
     * 
     * @param filterMapping - The {@link ModuleFilterMapping} to check for matching servlets and url patterns
     * @param requestPath - The URI of the request to check against the {@link ModuleFilterMapping}
     * @return - true if the given {@link ModuleFilterMapping} matches the passed requestPath
     * 
     * For example:
     * Passing a ModuleFilterMapping containing a urlPattern of "*" would return true for any requestPath
     * Passing a ModuleFilterMapping containing a urlPattern of "*.jsp" would return true for any requestPath ending in ".jsp"
     * 
     * @should return false if the requestPath is null
     * @should return true if the ModuleFilterMapping contains any matching urlPatterns for this requestPath
     * @should return true if the ModuleFilterMapping contains any matching servletNames for this requestPath
    ...
    /**
     * Return <code>true</code> if the specified servlet name matches the filterMapping
     * otherwise return <code>false</code>.
     *
     * @param patternToCheck String pattern to check
