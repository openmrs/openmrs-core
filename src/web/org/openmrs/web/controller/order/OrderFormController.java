...
public class OrderFormController extends SimpleFormController {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object obj, BindException errors) throws Exception {
		...
		if (context != null && context.isAuthenticated()) {
			...
			if ( order.isVoided() == null ) order.setVoided(new Boolean(false));
    ...
    protected Object formBackingObject(HttpServletRequest request) throws ServletException {
		...
		if (context != null && context.isAuthenticated()) {
			...
			String orderId = RequestUtils.getStringParameter(request, "orderId"); 
	    	if (orderId != null) order = os.getOrder(Integer.valueOf(orderId));	
		}
