 ...
 * attributes are returned. If 'type' is 'user', only user display attributes are returned.
 * This list is maintained with global properties: patient.displayAttributeTypes and 
 * user.displayAttributeTypes.  Both are comma delimited lists of either PersonAttributeType 
 * names or ids. 
 * 
 * @author bwolfe
 *
