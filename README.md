...
OpenMRS is a patient-based medical record system focusing on giving healthcare providers a free customizable electronic medical record system (EMR).
<<<<<<< HEAD
=======

>>>>>>> 0c5ae453b (FIX: Corrected typo in README.md)
The mission of OpenMRS is to improve healthcare delivery in resource-constrained environments by coordinating a global community that creates a robust, scalable, user-driven, open source medical record system platform.
