 ...
 * being in the list of "@TestExecutionListeners" annotation.
 * 
 *  This looks for the "@SkipInitializationData", "@SkipStandardData" and
 *  "@SkipAuthorization" annotations on the current test method and skips
 *  the associated action in the {@link BaseContextSensitiveTest#setupDatabaseWithStandardData()} 
 *  method
 *  
 *  @see SkipBaseSetup
 *  @see BaseContextSensitiveTest
 */
public class SkipBaseSetupAnnotationExecutionListener extends
        AbstractTestExecutionListener {
	
	/**
	 * This method is run before all "@Before" methods thanks to Spring and
	 * the "@TestExecutionListeners" annotation on the {@link BaseContextSensitiveTest}
	 * class.
	 * 
	...
	/**
     * Convenience method to call the given method on the current
     * test class as denoted by the TestContext
     * 
