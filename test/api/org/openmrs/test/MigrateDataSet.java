...
/**
 * This is a runnable java class that migrates/converts the current dbunit
 * xml files to a new schema structure. 
 * 
 * After running this class, you are able to pick either a folder to convert.  
 * Xmls files are recursively found and converted.
 * 
...
public class MigrateDataSet {
	...
	private static String[] credentials = BaseContextSensitiveTest.askForUsernameAndPassword("Enter your MYSQL DATABASE username and password");
