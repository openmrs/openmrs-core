 ...
 *  a valid identifier from an identifier that has not yet been given a check digit
 *  or other form of validation.  Each validator should also have a name, e.g. "Luhn Algorithm."
 */
public interface IdentifierValidator {
	 ...
	 * @throws UnallowedIdentifierException if the identifier contains unallowed characters
	 * or is otherwise not appropriate for this validator.
	 */
